...
player playMove "AinvPknlMstpSlayWrflDnon_medic"; // Begin the full medic animation...
...
player playMove "amovpknlmstpslowwrfldnon_amovpercmstpsraswrfldnon"; // Redundant reset of animation state to avoid getting locked in animation.